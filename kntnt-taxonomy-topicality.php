...
class Taxonomy {
	...
	public function run() {
		...
		$slug       = apply_filters( 'kntnt_taxonomy_topicality_slug', 'topicality' );
		$post_types = apply_filters( 'kntnt_taxonomy_topicality_objects', array( 'post' ) );
